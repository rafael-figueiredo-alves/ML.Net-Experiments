...
namespace FirstMLExperiment
{
    public partial class SentimentModel
    {
        public const string RetrainFilePath =  @"C:\MeusProjetos\ML.Net_Experiments\FirstMLExperiment\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=13,MinimumExampleCountPerLeaf=31,NumberOfTrees=91,MaximumBinCountPerFeature=625,FeatureFraction=0.859355171557539,LearningRate=0.215302813834681,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
